...
public class MusicbrainzWordDelimiterFilter extends TokenFilter {
   ...
   */
  public MusicbrainzWordDelimiterFilter(TokenStream in,
                                        byte[] charTypeTable,
   ...
   * 
   * @deprecated Use
   *             {@link #MusicbrainzWordDelimiterFilter(TokenStream, byte[], int, int, int, int, int, int, int, int, int, CharArraySet)}
   *             instead.
   */
  @Deprecated
  public MusicbrainzWordDelimiterFilter(TokenStream in,
  ...
  /**
   * @deprecated Use
   *             {@link #MusicbrainzWordDelimiterFilter(TokenStream, int, int, int, int, int, int, int, int, int, CharArraySet)}
   *             instead.
   */
  @Deprecated
  public MusicbrainzWordDelimiterFilter(TokenStream in,
